  ...
  'About Crisis Trends Data': {
    ...
    'questions': {
      ...
      'Where does the data come from?': {
        'How is the data collected?': 'The visualizations you see are powered by data gathered in our conversations with texters. Following each conversation, volunteer Crisis Counselors (CCs) complete a survey and select which issues the texter mentioned. We gather this data so that we can get a better understanding of the needs of our texters and how we can best prepare Crisis Counselors to support them.',
        'How is the data anonymized?': 'To us, texter privacy is always first and foremost! All data is scrubbed of any personally identifiable information that a texter might have chosen to share, including names, addresses, dates of birth, phone numbers, and email addresses, prior to sharing with researchers. It is additionally aggregated before we share it publicly on CrisisTrends.org, because we intend to show you just that: trends!',
      ...
      'What data can I access?': {
        ...
        'Do you have data from other countries?': 'Not yet! We started our service in 2013 in the U.S. Now, we are excited to be working with partners internationally to increase access to free, 24/7 crisis support via text to people around the world. You can learn more about our plans for international expansion at <a href=\"http://www.crisistextline.org/international/\" target=\"_blank\">Crisis Text Line International</a>.',
        ...
        'How should I cite this data?': 'We share this data with you so you can share it with others as you see fit. If you do share it, please cite it as: <pre>\"Crisis Trends.\" www.crisistrends.org. Crisis Text Line, December 2016. Web. &lt;Insert your date of access&gt;.</pre> And, let us know at <a href=\"mailto:support@crisistextline.org\">data@crisistextline.org</a>! We would love to maintain a growing list of how this data is being used so we can trace impact and make improvements as we go.',
        'I\'d like to gather data like this on my specific community. What do I do?': 'You might be a great fit as a partner. Please complete <a href=\"http://www.surveygizmo.com/s3/2612353/CrisisTextLinePartners\" target=\"_blank\">this survey</a> to learn more.',
        'What if my question was not answered / I have a really good suggestion?': 'Questions, suggestions, ideas? We\'d love to hear from you! Email us at <a href=\"mailto:support@crisistextline.org\">support@crisistextline.org</a>',
      },
    },
  },
